...
class MediaConverter:
    def __init__(self, root):
        ...
        self.select_option_label = tk.Label(self.select_frame, text="Select Conversion Type:")
        self.select_option_label.pack()

        self.selected_option = tk.StringVar()
        self.audio_radio_button = tk.Radiobutton(self.select_frame, text="Audio", variable=self.selected_option, value="audio")
        self.audio_radio_button.pack(anchor="w")
        self.video_radio_button = tk.Radiobutton(self.select_frame, text="Video", variable=self.selected_option, value="video")
        self.video_radio_button.pack(anchor="w")

        self.upload_button = tk.Button(root, text="Upload Media Files", command=self.upload_media_files)
        ...
        self.input_media_label = tk.Label(root, text="Uploaded Media Files:")
